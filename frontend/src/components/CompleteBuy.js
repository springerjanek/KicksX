      ...
      {isSwitchedToPlaceBid ? (
        <>
          ...
          <div className="bg-white text-black rounded mr-10">
            <div className="flex flex-wrap gap-2 w-1/3 mt-10 p-3">
              <BanknotesIcon className="h-5 ml-2 mt-[3px] basis-1/4" />
              <p className="basis-1/2">{userSummary.payment}</p>
              <div className="w-102 bg-black h-px ml-9"></div>
              <HomeIcon className="h-5 ml-2 mt-[3px] basis-1/4" />
